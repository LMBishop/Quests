...
public final class BedWars2023LoseTask extends BukkitTaskType {

    private final BukkitQuestsPlugin plugin;

    public BedWars2023LoseTask(BukkitQuestsPlugin plugin) {
        super("bedwars2023_lose", TaskUtils.TASK_ATTRIBUTION_STRING, "Lose a game of BedWars in BedWars2023.");
        this.plugin = plugin;
