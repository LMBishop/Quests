...
public final class BedWars2023FinalKillTask extends BukkitTaskType {

    private final BukkitQuestsPlugin plugin;

    public BedWars2023FinalKillTask(BukkitQuestsPlugin plugin) {
        super("bedwars2023_finalkill", TaskUtils.TASK_ATTRIBUTION_STRING, "Get a final kill in BedWars2023.");
        this.plugin = plugin;
