...
public final class BedWars2023GeneratorCollectTask extends BukkitTaskType {

    private final BukkitQuestsPlugin plugin;

    public BedWars2023GeneratorCollectTask(BukkitQuestsPlugin plugin) {
        super("bedwars2023_generator_collect", TaskUtils.TASK_ATTRIBUTION_STRING, "Collect specific items from BedWars2023 generators.");
        this.plugin = plugin;
